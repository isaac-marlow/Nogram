...
public class BuildVars {
    ...
    public static boolean CAN_DOWNLOAD_APP_UPDATE = false;
    ...
    public static String PLAYSTORE_APP_URL = "https://play.google.com/store/apps/details?id=com.nogram.messenger";
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && "com.nogram.messenger.beta".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return betaApp;
    }
